...
def get_dataset_config(dataset_name):
    ...
    # Dataset-specific parameters (based on paper Tables 1 & 2)
...
def run_full_ablation_study(args):
    """Run complete ablation study for a dataset"""
    ...
    if args.single_config:
        ...
        print("Running single configuration only (for quick testing)")
    ...
    # Ablation configurations - Option A: (flags_tuple, name) pairs
    ablation_configs = [
...
def main():
    ...
    if args.single_config:
        print("Single config flag detected - this will be handled in run_full_ablation_study")
